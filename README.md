...
<p>Данные плейбуки используются для сбора информации и обновления модулей на 50+ разнообразных серверах Windows и Linux.<br>
В плейбуках используется формирование и отправка сообщений в ТГ каналы.<br>
Все файлы инвентаря защищены с помощью <b>Ansible Vault</b>.<br>
Так же работа с плейбуками настроена через <b>Ansible Semaphore</b>.</p>
...
Все плейбуки которые выполняют обновление без использования архива, сначала проверяют на наличие данного файла, и только после этого его обновляют.</p>
<ul>
